// References for the tbody element, input fields and buttons:
...
function handleSearchButtonClick() {
  // Pass through search items with formatted user's search terms by removing leading and trailing whitespace:
